...
ENV_KEYS = [
    ...
    # custom web→API provider: the ChatGPT-bridge workflow publishes its
    # tunnel URL here; the pool router re-reads ~/.hermes/.env live, so a
    # new bridge URL goes live mid-run with NO restart.
